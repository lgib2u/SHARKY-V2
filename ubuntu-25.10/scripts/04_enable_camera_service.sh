...
echo "Ubuntu 25.10: enabling camera publisher service..."

SERVICE_TMP="/tmp/libcamera_ros.service"
SERVICE_PATH="/etc/systemd/system/libcamera_ros.service"

echo "Writing systemd service to run camera_ros on boot..."
...
echo "Service enabled. Use: journalctl -u libcamera_ros -f to follow logs."
